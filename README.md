...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Nurutomo/kitola)
...
git clone https://github.com/Nurutomo/kitola
cd kitola
npm install
npm update
```
...
Now set using switch [enable.js](https://github.com/Nurutomo/kitola/blob/master/plugins/enable.js), among others are
